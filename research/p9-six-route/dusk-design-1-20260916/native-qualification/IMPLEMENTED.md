...
Coherent implementation `92da314c066b84fc565c428cbbda03375ef03481`. INV-10 log `native-tests-1.log` blob `d722fd0d88f6f84f6a0a58cbde0e55d99fd41f6a`. INV-11 is a **distinct** Godot process (`native-tests-2.time`: real 2.32s, 02:56:02–02:56:05); both print `PASS (2 tests)` and `native_starts=201` + `45`. Matrix blob `5411fef977049782dd93aee2a193fe180b349695`.
...
2. **Per-invocation identities.** INV-1..3 / headed pin O combat `8110f15e` / test `baaeff7b`. INV-4..6 pin repair `ab74e33b` combat `8353b395` / test `3cc6bdbc`. INV-10/11 pin `92da314` combat `4288f589` / overlay test `1daa3f8f` / matrix `5411fef977049782dd93aee2a193fe180b349695` / reader `6c08fc23`. E was not attached to earlier runs.
