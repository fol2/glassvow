...
CHECKS=('live_state_unchanged','second_query_unchanged','public_frame_retained','hidden_change_is_private','hidden_input_independent','same_public_determinization','intervention_flags_retained','legal_action','paid_play_succeeded','does_not_choose_known_fatal_source','fixed_one_sample','content_readonly','rule_switches_readonly')
KEYS=('aspect','vow','upgraded','pattern','modifiers','route')
PARAMETERS={'bank_mode':'current-plus-next','native_rollout':True,'rollout_samples':1,'rollout_steps':12,'leaf_terminal':False}
...
def independently_check(row):
 ...
 'fixed_one_sample':d['root_rollouts']==len(d['legal_candidates']),
