extends SceneTree
## Pristine current-main comparator for issue #421 Scoreline commitment.
...
func _commitment_snapshot(
	...
	return {
		...
		"contentHasOath": content.relics.has("research421ScorelineOath"),
...
func _fail(message: String) -> void:
	push_error("research_421_scoreline_commitment_baseline_probe: %s" % message)
	quit(2)
