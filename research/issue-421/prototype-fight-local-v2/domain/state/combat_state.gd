...
## Research-only, combat-scoped mediators for issue #421. They are absent from
## fixture/save projections and remain empty at the exact null settings.
var research421_scoreline_targets: Dictionary = {}
var research421_afterimage_ward: int = 0
