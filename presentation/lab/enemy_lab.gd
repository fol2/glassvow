class_name EnemyLab
extends Control
## Stub. The enemy lab lands here — this file is a boot harness, nothing else.
##
##   godot --path . -- --enemies                        # window, stays open
##   godot --path . -- --enemies --shot=/tmp/enemies.png  # headless capture
