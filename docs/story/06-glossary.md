...
| zh-Hant | en | 意義 | 狀態 |
|---|---|---|---|
| 守夜之爐 / Vigil | the Vigil | 西端爐火;跨 run 帳簿所在 | locked(shipped) |
| 燼璃 | emberglass | 一體之火碎成的六片 | locked(shipped) |
| 彩窗 | Rose Window | 爐邊六格窗;開封時成鏡 | locked(shipped) |
| 空燈掌燈人 | Hollow Lamplighter | 五會老者,A4 錨點 | locked(shipped) |
| 永恆君王 | the Sovereign | 第一行者,偽王,act3 boss | locked(shipped) |
| 影 | the Shade | 行者記憶迴聲 | locked(shipped) |
...
- zh-Hant 為源語言,**香港書面語**;「着/裏」正字 gate。
- en 為全文重寫,禁 calque。
- 對白可依角色聲線調整語域(見 02-cast voice 欄),敘述文一律書面語。
