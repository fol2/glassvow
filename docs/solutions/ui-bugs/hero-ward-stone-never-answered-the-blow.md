...
- `ward_hit(from)` (`presentation/combat/enemy_view.gd:2484` (`ward_hit`)) — the
...
(`presentation/combat/enemy_view.gd:2484` (`ward_hit`)), correct for a foe struck
...
`_step_ward` (`presentation/combat/enemy_view.gd:2539` (`_step_ward`)) then does
