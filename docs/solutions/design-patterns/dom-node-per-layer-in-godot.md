...
[presentation/combat/hud_bar.gd:1250-1253](../../../presentation/combat/hud_bar.gd#L1250) (in `_sync_pile`):
...
- **An inner class cannot see the outer class's statics unqualified.**
  ...
  resolves ([presentation/combat/hud_bar.gd:1266](../../../presentation/combat/hud_bar.gd#L973) (`_fan_angle`)).
...
- `presentation/combat/hud_bar.gd:1151-1179` (in `fly_backs`) builds a
  ...
  carves out.
- `presentation/combat/hud_bar.gd:430-452` (in `_sync_candles`) builds one
