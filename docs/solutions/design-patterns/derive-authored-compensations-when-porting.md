...
| `--foot-ox`, `--foot-oy` | Scanned off the painting's own alpha: lowest opaque row is the contact point, its horizontal centroid is where weight sits (`enemy_view.gd:1687` (`_read_contact`)) |
...
(`enemy_view.gd:1678-1679` (`CAST_MIN`)):
...
# RIGHT — fold the scale into the same basis (enemy_view.gd:1757-1761 (in _update_shadow))
