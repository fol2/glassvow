...
`combat_screen.gd:1511` (`_play_entrance`)). The `view.enter(...)` call in `_build_battlefield`,
...
from `combat_screen._float` (`combat_screen.gd:2312-2317` (`_float`)). The benchmark's crit
...
(`vfx_layer.gd:617` (`archetype_hit`), `combat_screen.gd:2718` (`_hit_enemy`)). `DEAD_KINDS_RENDER = false` drops
...
(`combat_screen.gd:1589` (`_hero_look`)); the hard-code survives only as the
