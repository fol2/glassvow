...
`combat_screen.gd:1509` (`_play_entrance`)). The `view.enter(...)` call in `_build_battlefield`,
...
from `combat_screen._float` (`combat_screen.gd:2310-2315` (`_float`)). The benchmark's crit
...
(`vfx_layer.gd:617` (`archetype_hit`), `combat_screen.gd:2716` (`_hit_enemy`)). `DEAD_KINDS_RENDER = false` drops
...
(`combat_screen.gd:1587` (`_hero_look`)); the hard-code survives only as the
